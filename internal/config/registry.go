...
func (cfg *registry) parseConfigValues() error {
	...
	authority, username, password, token :=
		os.Getenv("BUILDX_REGISTRY_AUTH_AUTHORITY"),
		os.Getenv("BUILDX_REGISTRY_AUTH_USERNAME"),
		os.Getenv("BUILDX_REGISTRY_AUTH_PASSWORD"),
		os.Getenv("BUILDX_REGISTRY_AUTH_TOKEN")
