...
def main(baseline_report, new_report):
    report1_obj = buildx(report_path=baseline_report)
    report1_packages, report1_metadata = report1_obj.packages()

    report2_obj = buildx(report_path=new_report)
...
if __name__ == "__main__":
    print("\nComparing two buildx reports...\n")
    if len(sys.argv) != 3:
        sys.exit("please provide two buildx json files")
