...
import (
	...
	"github.com/metasources/buildx/cmd/buildx/cli/poweruser"
...
const powerUserExample = `  {{.appName}} {{.command}} <image>
  ...
  All behavior is controlled via application configuration and environment variables (see https://github.com/metasources/buildx#configuration)
`
