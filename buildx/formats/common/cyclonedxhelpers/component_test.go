...
func Test_encodeComponentProperties(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expected: &[]cyclonedx.Property{
				{Name: "buildx:package:foundBy", Value: "cataloger"},
				{Name: "buildx:location:0:path", Value: "test"},
				{Name: "buildx:metadata:gitCommitOfApkPort", Value: "97b1c2842faa3bfa30f5811ffbf16d5ff9f1a479"},
				{Name: "buildx:metadata:installedSize", Value: "4096"},
				{Name: "buildx:metadata:originPackage", Value: "libc-dev"},
				{Name: "buildx:metadata:provides:0", Value: "so:libc.so.1"},
				{Name: "buildx:metadata:pullChecksum", Value: "Q1p78yvTLG094tHE1+dToJGbmYzQE="},
				{Name: "buildx:metadata:pullDependencies:0", Value: "musl-utils"},
				{Name: "buildx:metadata:size", Value: "0"},
			},
		},
		{
			name: "from dpkg",
			...
			expected: &[]cyclonedx.Property{
				{Name: "buildx:package:metadataType", Value: "DpkgMetadata"},
				{Name: "buildx:metadata:installedSize", Value: "3036"},
				{Name: "buildx:metadata:source", Value: "tzdata-dev"},
				{Name: "buildx:metadata:sourceVersion", Value: "1.0"},
			},
		},
		{
			name: "from go bin",
			...
			expected: &[]cyclonedx.Property{
				{Name: "buildx:package:language", Value: pkg.Go.String()},
				{Name: "buildx:package:metadataType", Value: "GolangBinMetadata"},
				{Name: "buildx:package:type", Value: "go-module"},
				{Name: "buildx:metadata:architecture", Value: "amd64"},
				{Name: "buildx:metadata:goCompiledVersion", Value: "1.17"},
				{Name: "buildx:metadata:h1Digest", Value: "h1:KlOXYy8wQWTUJYFgkUI40Lzr06ofg5IRXUK5C7qZt1k="},
			},
		},
		{
			name: "from go mod",
			...
			expected: &[]cyclonedx.Property{
				{Name: "buildx:package:language", Value: pkg.Go.String()},
				{Name: "buildx:package:metadataType", Value: "GolangModMetadata"},
				{Name: "buildx:package:type", Value: "go-module"},
				{Name: "buildx:metadata:h1Digest", Value: "h1:KlOXYy8wQWTUJYFgkUI40Lzr06ofg5IRXUK5C7qZt1k="},
			},
		},
		{
			...
			expected: &[]cyclonedx.Property{
				{Name: "buildx:package:metadataType", Value: "RpmMetadata"},
				{Name: "buildx:package:type", Value: "rpm"},
				{Name: "buildx:metadata:epoch", Value: "2"},
				{Name: "buildx:metadata:release", Value: "1"},
				{Name: "buildx:metadata:size", Value: "12406784"},
				{Name: "buildx:metadata:sourceRpm", Value: "dive-0.9.2-1.src.rpm"},
			},
		},
	}
