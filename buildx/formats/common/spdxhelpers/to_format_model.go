...
import (
	...
	"github.com/metasources/buildx/internal/spdxlicense"
	"github.com/metasources/buildx/buildx/artifact"
	"github.com/metasources/buildx/buildx/file"
	"github.com/metasources/buildx/buildx/formats/common/util"
...
func toPackages(catalog *pkg.Catalog, sbom sbom.SBOM) (results []*spdx.Package) {
	for _, p := range catalog.Sorted() {
		...
		// 1. buildx has generated a sha1 digest for the package itself - usually in the java cataloger
		// 2. buildx has generated a sha1 digest for the package's contents
...
func toPackageChecksums(p pkg.Package) ([]spdx.Checksum, bool) {
	...
	case pkg.JavaMetadata:
		// if buildx has generated the digest here then filesAnalyzed is true
