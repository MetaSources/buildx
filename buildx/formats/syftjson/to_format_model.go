...
func ToFormatModel(s sbom.SBOM) model.Document {
	...
	if err != nil {
		log.Warnf("unable to create buildx-json source object: %+v", err)
	}
	...
	return model.Document{
		...
		Schema: model.Schema{
			...
			URL:     fmt.Sprintf("https://raw.githubusercontent.com/metasources/buildx/main/schema/json/schema-%s.json", internal.JSONSchemaVersion),
		},
	}
}
