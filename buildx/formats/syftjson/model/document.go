...
// Document represents the buildx cataloging findings as a JSON document
type Document struct {
	...
	Descriptor            Descriptor     `json:"descriptor"`        // Descriptor is a block containing self-describing information about buildx
